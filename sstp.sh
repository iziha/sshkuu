...
wget -O /etc/accel-ppp.conf "https://iziha.host/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/add-sstp https://iziha.host/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://iziha.host/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://iziha.host/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://iziha.host/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
rm -f /root/sstp.sh

...
# Tambahan
cd /usr/bin
wget -O add-wg "https://iziha.host/add-wg.sh"
wget -O del-wg "https://iziha.host/del-wg.sh"
wget -O cek-wg "https://iziha.host/cek-wg.sh"
wget -O renew-wg "https://iziha.host/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
